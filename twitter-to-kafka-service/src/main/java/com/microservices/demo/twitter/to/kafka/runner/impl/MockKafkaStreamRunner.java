...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public void start() throws TwitterException {
        ...
        LOGGER.info("Starting mock filtering tweeter streams for keywords {]", Arrays.toString(keyWords));
        simulateTwitterStream(keyWords, mockSleepMs, minTweetLength, maxTweetLength);
    }

    private void simulateTwitterStream(String[] keyWords, Long mockSleepMs, Integer minTweetLength, Integer maxTweetLength) throws TwitterException {
